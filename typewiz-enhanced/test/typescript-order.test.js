...
console.log(greetUser(myUser));
                ...
                rules: [
                    {
                        test: /\.ts$/,
                        use: [
                            // TypeWiz loader first (executes last after ts-loader)
                            {
                            ...
                            // ts-loader second (executes first)
                            {
                                loader: 'ts-loader',
                                options: {
                                    transpileOnly: false, // Let's see what happens without transpileOnly
                                    compilerOptions: {
                                        target: 'es2015',
                                        module: 'commonjs',
                                        strict: false
        ...
        console.log('Testing TypeWiz + ts-loader without enforce:pre and without transpileOnly...');
    ...
    it('should work with TypeWiz + ts-loader with transpileOnly:true', (done) => {
        jest.setTimeout(15000);
...
console.log(greetUser(myUser));
        ...
        webpack(webpackConfig, (err, stats) => {
            ...
            console.log('Compilation with transpileOnly:true successful!');
            console.log('Bundle contains $_$twiz:', bundleContent.includes('$_$twiz'));
